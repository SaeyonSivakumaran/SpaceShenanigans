		...
		gl_RepairPanel.setHorizontalGroup(
			gl_RepairPanel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_RepairPanel.createSequentialGroup()
					...
					.addGap(71)
					.addComponent(lblCost, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					...
					.addGroup(gl_RepairPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_RepairPanel.createSequentialGroup()
							.addGroup(gl_RepairPanel.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_RepairPanel.createParallelGroup(Alignment.LEADING)
									.addComponent(label_40, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
									.addGroup(gl_RepairPanel.createSequentialGroup()
										.addGap(18)
										.addComponent(label_41))
									.addComponent(label_42, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
									.addGroup(gl_RepairPanel.createSequentialGroup()
										.addGap(18)
							...
							.addGroup(gl_RepairPanel.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(label_46, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_RepairPanel.createSequentialGroup()
									.addGap(18)
